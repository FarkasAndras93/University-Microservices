...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__recipe_product_page__ = __webpack_require__(339);
...
var RecipeNewPageModule = /** @class */ (function () {
    ...
    RecipeNewPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__recipe_product_page__["a" /* RecipeProductPage */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__recipe_product_page__["a" /* RecipeProductPage */]),
...
//# sourceMappingURL=recipe-product.page.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RecipeProductPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__model_frontend_common_HeaderModel__ = __webpack_require__(308);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_product_product_provider__ = __webpack_require__(208);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__model_backend_product_my_product__ = __webpack_require__(321);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__model_frontend_product_recipe_product__ = __webpack_require__(340);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RecipeProductPage = /** @class */ (function () {
    function RecipeProductPage(toast, viewCtrl, storage, productProvider, navParams) {
        this.toast = toast;
        this.viewCtrl = viewCtrl;
        this.storage = storage;
        this.productProvider = productProvider;
        this.navParams = navParams;
        this.headerModel = new __WEBPACK_IMPORTED_MODULE_2__model_frontend_common_HeaderModel__["b" /* HeaderModel */]("New recipe", undefined, true, undefined, new __WEBPACK_IMPORTED_MODULE_3__model_frontend_common_ButtonModel__["a" /* ButtonModel */](undefined, undefined, undefined, undefined, __WEBPACK_IMPORTED_MODULE_4__components_simple_app_header_simple_app_header_component__["a" /* HEADER_BUTTON_TYPE */].CLOSE.toString()));
    }
    RecipeProductPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.possibleProducts = [];
        if (!__WEBPACK_IMPORTED_MODULE_6__utils_global_utils__["a" /* GlobalUtils */].isUndefinedOrNull(this.navParams.get("products") && this.navParams.get("products").length > 0)) {
            this.navParams.get("products").forEach(function (product) {
                _this.possibleProducts.push(new __WEBPACK_IMPORTED_MODULE_10__model_frontend_product_recipe_product__["a" /* RecipeProduct */](true, product));
            });
        }
        this.productProvider.getAllProducts().then(function (products) {
            products.forEach(function (product) {
                if (__WEBPACK_IMPORTED_MODULE_6__utils_global_utils__["a" /* GlobalUtils */].isUndefinedOrNull(_this.possibleProducts.filter(function (obj) { return obj.myProduct.product.name == product.name; })[0])) {
                    _this.possibleProducts.push(new __WEBPACK_IMPORTED_MODULE_10__model_frontend_product_recipe_product__["a" /* RecipeProduct */](false, new __WEBPACK_IMPORTED_MODULE_9__model_backend_product_my_product__["b" /* MyProduct */](undefined, product, _this.storage.getLoggedUser(), undefined, undefined, __WEBPACK_IMPORTED_MODULE_9__model_backend_product_my_product__["a" /* MYPRODUCT_TYPE */].RECIPE)));
                }
            });
     ...
     */
    RecipeProductPage.prototype.dismissModal = function () {
     ...
     * @memberof RecipeProductPage
     */
    RecipeProductPage.prototype.addProducts = function () {
        var products = this.possibleProducts.filter(function (product) {
            return (product.checked == true);
            //  &&
            //   GlobalUtils.isUndefinedOrNull(this.navParams.get("products").filter(prod => prod.name == product.myProduct.product.name)[0])) ||
            //   (product.checked == false &&
            //     !GlobalUtils.isUndefinedOrNull(this.navParams.get("products").filter(prod => prod.name == product.myProduct.product.name)[0]))
        });
        if (products.filter(function (product) {
            if (__WEBPACK_IMPORTED_MODULE_6__utils_global_utils__["a" /* GlobalUtils */].isUndefinedOrNull(product.myProduct.weight) || product.myProduct.weight <= 0) {
                return true;
            }
            else {
                return false;
    ...
    RecipeProductPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'recipe-product',template:/*ion-inline-start:"E:\dev\MechanicApp\MechanicApp\src\pages\recipe\recipe-product\recipe-product.page.html"*/'<simple-app-header [header]="headerModel" (onCloseBtnClick)="dismissModal()"></simple-app-header>\n\n<ion-content padding>\n  <ion-list>\n    <ion-searchbar class="custom-searchbar" placeholder="Suche" [(ngModel)]="searchProduct"></ion-searchbar>\n    <ion-item *ngFor="let item of possibleProducts | fullTextSearch:searchProduct:\'name\'">\n      <ion-label class="name-label">{{item.myProduct.product.name}}</ion-label>\n      <ion-checkbox [(ngModel)]="item.checked"></ion-checkbox>\n      <ion-input class="weight-input" [(ngModel)]="item.myProduct.weight"></ion-input>\n    </ion-item>\n  </ion-list>\n\n  <ion-row>\n    <ion-col class="center">\n      <button ion-button (click)="addProducts()">Save</button>\n    </ion-col>\n  </ion-row>\n</ion-content>'/*ion-inline-end:"E:\dev\MechanicApp\MechanicApp\src\pages\recipe\recipe-product\recipe-product.page.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5__providers_tehnical_toast_toast_provider__["a" /* ToastProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* ViewController */], __WEBPACK_IMPORTED_MODULE_7__providers_tehnical_storage_storage_provider__["a" /* StorageProvider */],
            __WEBPACK_IMPORTED_MODULE_8__providers_product_product_provider__["a" /* ProductProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */]])
    ], RecipeProductPage);
    return RecipeProductPage;
}());

//# sourceMappingURL=recipe-product.page.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RecipeProduct; });
/**
 * Recipe products add.
 *
 * @export
 ...
 * @extends {MyProduct}
 */
var RecipeProduct = /** @class */ (function () {
    function RecipeProduct(checked, myProduct) {
...
//# sourceMappingURL=recipe-product.js.map
