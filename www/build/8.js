...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProductEditorPageModule", function() { return ProductEditorPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__product_editor_page__ = __webpack_require__(331);
...
var ProductEditorPageModule = /** @class */ (function () {
    function ProductEditorPageModule() {
    }
    ProductEditorPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__product_editor_page__["a" /* ProductEditorPage */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__product_editor_page__["a" /* ProductEditorPage */]),
    ...
    return ProductEditorPageModule;
}());

//# sourceMappingURL=product-editor.page.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ProductEditorPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(34);
...
var ProductEditorPage = /** @class */ (function () {
    function ProductEditorPage(navCtrl, productProvider, modalCtrl, toast, alertCtrl) {
        this.navCtrl = navCtrl;
        this.productProvider = productProvider;
        this.modalCtrl = modalCtrl;
        this.toast = toast;
        this.alertCtrl = alertCtrl;
        this.headerModel = new __WEBPACK_IMPORTED_MODULE_4__model_frontend_common_HeaderModel__["b" /* HeaderModel */]("Product Editor", __WEBPACK_IMPORTED_MODULE_4__model_frontend_common_HeaderModel__["a" /* HEADER_COLORS */].BASE, true, new __WEBPACK_IMPORTED_MODULE_5__model_frontend_common_ButtonModel__["a" /* ButtonModel */](undefined, undefined, undefined, undefined, __WEBPACK_IMPORTED_MODULE_6__components_simple_app_header_simple_app_header_component__["a" /* HEADER_BUTTON_TYPE */].MENU_TOGGLE.toString()));
    }
    ProductEditorPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.productProvider.getAllProducts().then(function (result) {
            _this.products = result;
        }).catch(function (error) {
            console.log("Error while geting all products!");
            _this.toast.showErrorMessage("Error while geting all products!");
        });
    };
    /**
     ...
     */
    ProductEditorPage.prototype.createProduct = function () {
        var _this = this;
        var modal = this.modalCtrl.create('ProductEditorNewPage');
        modal.present();
        modal.onDidDismiss(function (result) {
            if (!__WEBPACK_IMPORTED_MODULE_7__utils_global_utils__["a" /* GlobalUtils */].isUndefinedOrNull(result)) {
                if (result instanceof __WEBPACK_IMPORTED_MODULE_2__model_backend_product_product__["b" /* Product */]) {
                    _this.productProvider.createProductInDatabase(result).then(function (newProduct) {
                        console.log(result);
                        _this.products.push(result);
                        _this.toast.showSuccessMessage("Product added with success.");
                    }).catch(function (err) {
                        console.error("Failed to add new product in database!", err);
                        _this.toast.showErrorMessage("Add product failed!");
                    });
                }
                else {
                    _this.toast.showErrorMessage("Add product failed!");
     ...
     * @memberof ProductEditorPage
     */
    ProductEditorPage.prototype.removeProduct = function (product) {
        var _this = this;
        this.productProvider.removeProductFromDatabase(product).then(function (value) {
            if (value) {
                _this.products.splice(_this.products.indexOf(product), 1);
            }
            else {
                _this.toast.showErrorMessage("Failed to remove product!");
            }
        }).catch(function (error) {
            console.log("Error while removing product from the database.");
            _this.toast.showErrorMessage("Error while removing product!");
        });
    };
    ProductEditorPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'product-editor',template:/*ion-inline-start:"E:\dev\MechanicApp\MechanicApp\src\pages\product-editor\product-editor-list\product-editor.page.html"*/'<simple-app-header [header]="headerModel"></simple-app-header>\n\n<ion-content padding>\n  <ion-list>\n    <ion-item *ngFor="let product of products">\n      <ion-avatar item-left>\n        <img src="assets/imgs/products/product-{{product.type}}.jpg">\n      </ion-avatar>\n      <h2>{{product.name}}</h2>\n      <ion-buttons item-right>\n        <button ion-fab clear (click)="removeProduct(product)" color="bluedark" class="list-item-button">\n          <ion-icon name="trash"></ion-icon>\n        </button>\n      </ion-buttons>\n    </ion-item>\n  </ion-list>\n</ion-content>\n\n<ion-fab right bottom>\n  <button ion-fab (click)="createProduct()" color="bluedark">\n    <ion-icon name="add"></ion-icon>\n  </button>\n</ion-fab>'/*ion-inline-end:"E:\dev\MechanicApp\MechanicApp\src\pages\product-editor\product-editor-list\product-editor.page.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_3__providers_product_product_provider__["a" /* ProductProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* ModalController */], __WEBPACK_IMPORTED_MODULE_8__providers_tehnical_toast_toast_provider__["a" /* ToastProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]])
    ], ProductEditorPage);
    return ProductEditorPage;
}());

//# sourceMappingURL=product-editor.page.js.map
