...
//    */
//   public checkProduct() {
//     this.productProvider.checkProductInGrocery(this.groceryList).then(status => {
//       if (!status) {
...
//    */
//   public addProduct() {
//     let modal = this.modalCtrl.create('GroceryNewProductPage', { "existentProducts": this.groceryList.groceryProducts });
//     modal.present();
//     modal.onDidDismiss((result: GroceryProduct[]) => {
//       if (!GlobalUtils.isUndefinedOrNull(result)) {
//         this.groceryList.groceryProducts = this.groceryList.groceryProducts.concat(result);
//         this.productProvider.createGroceryProducts(this.groceryList).then(editedGroceryList => {
//           // this.groceryList.products = this.groceryList.products.concat(products);
//           this.groceryList = editedGroceryList;
